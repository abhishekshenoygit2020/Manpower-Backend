const { create, getSoldDataCount,deletesByIdproduct,deletesByIdcategory,getLogDetails,deletesByIdsubcategory,deletesByIdwarrantyprotection,getById ,updateSalesrep, get, update, blockDealership,getByEmail,createWarranty,getPendingWarrantyGraph,getPendingWarranty,updateWarranty,getClosedWarranty,deletesByIdWarranty,gettableDataCount,getProductData,getClosedWonGraph} = require("./dealership.controller");
